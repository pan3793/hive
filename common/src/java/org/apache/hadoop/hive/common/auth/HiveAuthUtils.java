...
public class HiveAuthUtils {
  ...
  public static TTransport getSSLSocket(String host, int port, int loginTimeout,
    String trustStorePath, String trustStorePassWord, int maxMessageSize) throws TTransportException {
    return getSSLSocket(host, port, loginTimeout, loginTimeout, trustStorePath, trustStorePassWord, maxMessageSize);
  }

  public static TTransport getSSLSocket(String host, int port, int socketTimeout, int connectionTimeout,
    String trustStorePath, String trustStorePassWord) throws TTransportException {
    return getSSLSocket(host, port, socketTimeout, connectionTimeout, trustStorePath, trustStorePassWord, -1);
  }
