-- create database with multiple tables and views.
...
-- add a table and view with a different storage location
...
-- add a partitioned table and view
...
-- add a partitioned table and view with a different storage location
